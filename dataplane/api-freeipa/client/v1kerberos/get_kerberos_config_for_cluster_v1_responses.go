...
func (o *GetKerberosConfigForClusterV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetKerberosConfigForClusterV1OK()
...
func (o *GetKerberosConfigForClusterV1OK) Error() string {
	return fmt.Sprintf("[GET /v1/kerberos/cluster][%d] getKerberosConfigForClusterV1OK  %+v", 200, o.Payload)
}

func (o *GetKerberosConfigForClusterV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
