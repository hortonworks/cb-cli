...
/*
UsedRecipesV1 lists the images that are in use
*/
func (a *Client) UsedRecipesV1(params *UsedRecipesV1Params) (*UsedRecipesV1OK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewUsedRecipesV1Params()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "usedRecipesV1",
		Method:             "GET",
		PathPattern:        "/v1/utils/used_recipes/{accountId}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &UsedRecipesV1Reader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*UsedRecipesV1OK), nil
