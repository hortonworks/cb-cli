...
func (o *AttachChildEnvironmentV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	result := NewAttachChildEnvironmentV1Default(response.Code())
...
func NewAttachChildEnvironmentV1Default(code int) *AttachChildEnvironmentV1Default {
	return &AttachChildEnvironmentV1Default{
		_statusCode: code,
	}
}
...
func (o *AttachChildEnvironmentV1Default) Code() int {
	return o._statusCode
}

func (o *AttachChildEnvironmentV1Default) Error() string {
	return fmt.Sprintf("[POST /v1/freeipa/attach_child_environment][%d] attachChildEnvironmentV1 default ", o._statusCode)
}

func (o *AttachChildEnvironmentV1Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
