...
func (*mockUserClient) AssignRolesToUser(params *users.AssignRolesToUserParams) (*users.AssignRolesToUserOK, error) {
	return nil, nil
}

func (*mockUserClient) DeleteRolesFromUser(params *users.DeleteRolesFromUserParams) (*users.DeleteRolesFromUserOK, error) {
	return nil, nil
}
