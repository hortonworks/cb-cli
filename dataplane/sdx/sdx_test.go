...
func TestIfDatabaseNeeded(t *testing.T) {
	...
	setupExternalDbIfNeeded(true, false, false, "", false, &sdxRequest.ExternalDatabase)
...
func TestIfNonHaDatabaseNeeded(t *testing.T) {
	...
	setupExternalDbIfNeeded(false, false, true, "", false, &sdxRequest.ExternalDatabase)
...
func TestIfDatabaseNeededFalse(t *testing.T) {
	...
	setupExternalDbIfNeeded(false, true, false, "", false, &sdxRequest.ExternalDatabase)
