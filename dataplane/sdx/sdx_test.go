...
func TestEngineVersion(t *testing.T) {
	...
	setupExternalDbIfNeeded(true, false, false, &sdxRequest.ExternalDatabase, "13")

	if sdxRequest.ExternalDatabase.DatabaseEngineVersion != "13" {
		t.Errorf("database engine version not set")
	}
}
