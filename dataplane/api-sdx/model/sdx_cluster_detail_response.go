...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["REQUESTED","WAIT_FOR_ENVIRONMENT","ENVIRONMENT_CREATED","STACK_CREATION_IN_PROGRESS","STACK_CREATION_FINISHED","STACK_DELETED","STACK_DELETION_IN_PROGRESS","EXTERNAL_DATABASE_CREATION_IN_PROGRESS","EXTERNAL_DATABASE_DELETION_IN_PROGRESS","EXTERNAL_DATABASE_CREATED","RUNNING","PROVISIONING_FAILED","REPAIR_IN_PROGRESS","REPAIR_FAILED","CHANGE_IMAGE_IN_PROGRESS","UPGRADE_IN_PROGRESS","UPGRADE_FAILED","DELETE_REQUESTED","DELETED","DELETE_FAILED","START_REQUESTED","START_IN_PROGRESS","START_FAILED","STOP_REQUESTED","STOP_IN_PROGRESS","STOP_FAILED","STOPPED","CLUSTER_AMBIGUOUS","SYNC_FAILED"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// SdxClusterDetailResponseStatusSTARTREQUESTED captures enum value "START_REQUESTED"
	SdxClusterDetailResponseStatusSTARTREQUESTED string = "START_REQUESTED"
	...
	// SdxClusterDetailResponseStatusSTOPREQUESTED captures enum value "STOP_REQUESTED"
	SdxClusterDetailResponseStatusSTOPREQUESTED string = "STOP_REQUESTED"
