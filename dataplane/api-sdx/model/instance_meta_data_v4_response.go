...
type InstanceMetaDataV4Response struct {
	...
	// Enum: [REQUESTED FAILED CREATED ORCHESTRATION_FAILED SERVICES_RUNNING SERVICES_HEALTHY SERVICES_UNHEALTHY WAITING_FOR_REPAIR STOPPED DELETED_ON_PROVIDER_SIDE DELETED_BY_PROVIDER DELETE_REQUESTED DECOMMISSIONED DECOMMISSION_FAILED TERMINATED ZOMBIE]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["REQUESTED","FAILED","CREATED","ORCHESTRATION_FAILED","SERVICES_RUNNING","SERVICES_HEALTHY","SERVICES_UNHEALTHY","WAITING_FOR_REPAIR","STOPPED","DELETED_ON_PROVIDER_SIDE","DELETED_BY_PROVIDER","DELETE_REQUESTED","DECOMMISSIONED","DECOMMISSION_FAILED","TERMINATED","ZOMBIE"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// InstanceMetaDataV4ResponseInstanceStatusZOMBIE captures enum value "ZOMBIE"
	InstanceMetaDataV4ResponseInstanceStatusZOMBIE string = "ZOMBIE"
)
