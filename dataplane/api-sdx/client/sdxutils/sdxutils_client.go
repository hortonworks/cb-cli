...
func (a *Client) CheckClientVersionOfSdx(params *CheckClientVersionOfSdxParams) (*CheckClientVersionOfSdxOK, error) {
	...
	if params == nil {
		params = NewCheckClientVersionOfSdxParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "checkClientVersionOfSdx",
		Method:             "GET",
		PathPattern:        "/sdx/utils/client",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &CheckClientVersionOfSdxReader{formats: a.formats},
	...
	return result.(*CheckClientVersionOfSdxOK), nil
