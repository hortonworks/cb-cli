...
// WithName adds the name to the restore datalake status params
func (o *RestoreDatalakeStatusParams) WithName(name string) *RestoreDatalakeStatusParams {
	o.SetName(name)
	return o
}

// SetName adds the name to the restore datalake status params
func (o *RestoreDatalakeStatusParams) SetName(name string) {
	o.Name = name
}

// WithRestoreID adds the restoreID to the restore datalake status params
func (o *RestoreDatalakeStatusParams) WithRestoreID(restoreID *string) *RestoreDatalakeStatusParams {
	o.SetRestoreID(restoreID)
	return o
}

// SetRestoreID adds the restoreId to the restore datalake status params
func (o *RestoreDatalakeStatusParams) SetRestoreID(restoreID *string) {
