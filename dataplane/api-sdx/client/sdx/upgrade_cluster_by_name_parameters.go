...
// WithImage adds the image to the upgrade cluster by name params
func (o *UpgradeClusterByNameParams) WithImage(image string) *UpgradeClusterByNameParams {
	o.SetImage(image)
	return o
}

// SetImage adds the image to the upgrade cluster by name params
func (o *UpgradeClusterByNameParams) SetImage(image string) {
	o.Image = image
}
