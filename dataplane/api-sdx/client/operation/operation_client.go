...
/*
GetOperationProgressByResourceCrn gets provision flow operation progress details for resource by resource crn
...
func (a *Client) GetOperationProgressByResourceCrn(params *GetOperationProgressByResourceCrnParams) (*GetOperationProgressByResourceCrnOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Method:             "GET",
		PathPattern:        "/operation/resource/crn/{resourceCrn}",
