...
/*
AutoscaleStopInstancesByCrn stops multiple instances from the stack s cluster in workspace
...
func (a *Client) AutoscaleStopInstancesByCrn(params *AutoscaleStopInstancesByCrnParams) (*AutoscaleStopInstancesByCrnOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &AutoscaleStopInstancesByCrnReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
...
/*
AutoscaleStopInstancesByName stops multiple instances from the stack s cluster in workspace
...
func (a *Client) AutoscaleStopInstancesByName(params *AutoscaleStopInstancesByNameParams) (*AutoscaleStopInstancesByNameOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &AutoscaleStopInstancesByNameReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
...
/*
PutStackForAutoscaleStartByCrn updates stack to start instances by id
...
func (a *Client) PutStackForAutoscaleStartByCrn(params *PutStackForAutoscaleStartByCrnParams) (*PutStackForAutoscaleStartByCrnOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &PutStackForAutoscaleStartByCrnReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
...
/*
PutStackForAutoscaleStartByName updates stack to start instances by id
...
func (a *Client) PutStackForAutoscaleStartByName(params *PutStackForAutoscaleStartByNameParams) (*PutStackForAutoscaleStartByNameOK, error) {
	...
	result, err := a.transport.Submit(&runtime.ClientOperation{
		...
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &PutStackForAutoscaleStartByNameReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
