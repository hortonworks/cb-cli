...
func (o *GetCreateRecipeRequestForCliReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCreateRecipeRequestForCliOK()
...
func NewGetCreateRecipeRequestForCliOK() *GetCreateRecipeRequestForCliOK {
	return &GetCreateRecipeRequestForCliOK{}
}
...
func (o *GetCreateRecipeRequestForCliOK) Error() string {
	return fmt.Sprintf("[POST /v4/{workspaceId}/recipes/cli_create][%d] getCreateRecipeRequestForCliOK  %+v", 200, o.Payload)
}

func (o *GetCreateRecipeRequestForCliOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.CreateRecipeRequest)
