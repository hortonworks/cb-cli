...
/*
OsUpgradeByUpgradeSetsInternalStack upgrades the cluster o s by name and upgrades sets internal
*/
func (a *Client) OsUpgradeByUpgradeSetsInternalStack(params *OsUpgradeByUpgradeSetsInternalStackParams) (*OsUpgradeByUpgradeSetsInternalStackOK, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewOsUpgradeByUpgradeSetsInternalStackParams()
	}

	result, err := a.transport.Submit(&runtime.ClientOperation{
		ID:                 "osUpgradeByUpgradeSetsInternalStack",
		Method:             "POST",
		PathPattern:        "/v4/{workspaceId}/stacks/internal/{crn}/os_upgrade_by_upgrade_sets",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"http", "https"},
		Params:             params,
		Reader:             &OsUpgradeByUpgradeSetsInternalStackReader{formats: a.formats},
		Context:            params.Context,
		Client:             params.HTTPClient,
	})
	if err != nil {
	...
	return result.(*OsUpgradeByUpgradeSetsInternalStackOK), nil
