...
// WithAccountID adds the accountID to the stop stack in workspace v4 params
func (o *StopStackInWorkspaceV4Params) WithAccountID(accountID *string) *StopStackInWorkspaceV4Params {
	o.SetAccountID(accountID)
	return o
}

// SetAccountID adds the accountId to the stop stack in workspace v4 params
func (o *StopStackInWorkspaceV4Params) SetAccountID(accountID *string) {
