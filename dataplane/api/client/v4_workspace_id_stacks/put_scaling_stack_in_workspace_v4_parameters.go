...
// WithAccountID adds the accountID to the put scaling stack in workspace v4 params
func (o *PutScalingStackInWorkspaceV4Params) WithAccountID(accountID *string) *PutScalingStackInWorkspaceV4Params {
	o.SetAccountID(accountID)
	return o
}

// SetAccountID adds the accountId to the put scaling stack in workspace v4 params
func (o *PutScalingStackInWorkspaceV4Params) SetAccountID(accountID *string) {
