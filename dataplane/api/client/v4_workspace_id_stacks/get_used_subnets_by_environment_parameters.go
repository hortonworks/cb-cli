...
// WithWorkspaceID adds the workspaceID to the get used subnets by environment params
func (o *GetUsedSubnetsByEnvironmentParams) WithWorkspaceID(workspaceID int64) *GetUsedSubnetsByEnvironmentParams {
	o.SetWorkspaceID(workspaceID)
	return o
}

// SetWorkspaceID adds the workspaceId to the get used subnets by environment params
func (o *GetUsedSubnetsByEnvironmentParams) SetWorkspaceID(workspaceID int64) {
