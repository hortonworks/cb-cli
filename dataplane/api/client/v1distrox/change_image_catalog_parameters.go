...
func (o *ChangeImageCatalogParams) WithBody(body *model.ChangeImageCatalogV4Request) *ChangeImageCatalogParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the change image catalog params
func (o *ChangeImageCatalogParams) SetBody(body *model.ChangeImageCatalogV4Request) {
	o.Body = body
}
