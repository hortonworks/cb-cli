...
func (o *VerticalScalingByNameParams) WithBody(body *model.DistroXVerticalScaleV1Request) *VerticalScalingByNameParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the vertical scaling by name params
func (o *VerticalScalingByNameParams) SetBody(body *model.DistroXVerticalScaleV1Request) {
	o.Body = body
}
