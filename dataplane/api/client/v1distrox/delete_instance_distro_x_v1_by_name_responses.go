...
func (o *DeleteInstanceDistroXV1ByNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewDeleteInstanceDistroXV1ByNameOK()
...
func NewDeleteInstanceDistroXV1ByNameOK() *DeleteInstanceDistroXV1ByNameOK {
...
*/
type DeleteInstanceDistroXV1ByNameOK struct {
	Payload *model.FlowIdentifier
}

func (o *DeleteInstanceDistroXV1ByNameOK) Error() string {
	return fmt.Sprintf("[DELETE /v1/distrox/name/{name}/instance][%d] deleteInstanceDistroXV1ByNameOK  %+v", 200, o.Payload)
}

func (o *DeleteInstanceDistroXV1ByNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
