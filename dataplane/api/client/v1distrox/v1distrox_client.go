...
/*
VerticalScalingByCrn verticals scales the instances node type disks stack by crn
...
/*
VerticalScalingByName verticals scale the stack instances node type disks by name
