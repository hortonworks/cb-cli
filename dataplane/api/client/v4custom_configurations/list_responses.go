...
*/
type ListOK struct {
	Payload *model.CustomConfigurationsV4Responses
}

func (o *ListOK) Error() string {
	return fmt.Sprintf("[GET /v4/custom_configurations][%d] listOK  %+v", 200, o.Payload)
}

func (o *ListOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(model.CustomConfigurationsV4Responses)
