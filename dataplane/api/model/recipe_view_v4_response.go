...
type RecipeViewV4Response struct {
	...
	// type of recipe
	// Required: true
	// Enum: [PRE_SERVICE_DEPLOYMENT PRE_CLOUDERA_MANAGER_START PRE_AMBARI_START PRE_TERMINATION POST_SERVICE_DEPLOYMENT POST_CLOUDERA_MANAGER_START POST_AMBARI_START POST_CLUSTER_INSTALL]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["PRE_SERVICE_DEPLOYMENT","PRE_CLOUDERA_MANAGER_START","PRE_AMBARI_START","PRE_TERMINATION","POST_SERVICE_DEPLOYMENT","POST_CLOUDERA_MANAGER_START","POST_AMBARI_START","POST_CLUSTER_INSTALL"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// RecipeViewV4ResponseTypePRESERVICEDEPLOYMENT captures enum value "PRE_SERVICE_DEPLOYMENT"
	RecipeViewV4ResponseTypePRESERVICEDEPLOYMENT string = "PRE_SERVICE_DEPLOYMENT"
	...
	// RecipeViewV4ResponseTypePOSTSERVICEDEPLOYMENT captures enum value "POST_SERVICE_DEPLOYMENT"
	RecipeViewV4ResponseTypePOSTSERVICEDEPLOYMENT string = "POST_SERVICE_DEPLOYMENT"
