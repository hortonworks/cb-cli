...
const (
	...
	// ClusterViewV4ResponseStatusEXTERNALDATABASECREATIONFINISHED captures enum value "EXTERNAL_DATABASE_CREATION_FINISHED"
	ClusterViewV4ResponseStatusEXTERNALDATABASECREATIONFINISHED string = "EXTERNAL_DATABASE_CREATION_FINISHED"
