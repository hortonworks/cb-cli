...
const (
	...
	// ClusterTemplateV4RequestTypeDISCOVERYDATAANDEXPLORATION captures enum value "DISCOVERY_DATA_AND_EXPLORATION"
	ClusterTemplateV4RequestTypeDISCOVERYDATAANDEXPLORATION string = "DISCOVERY_DATA_AND_EXPLORATION"
