...
const (
	...
	// ClusterTemplateViewV4ResponseTypeDISCOVERYDATAANDEXPLORATION captures enum value "DISCOVERY_DATA_AND_EXPLORATION"
	ClusterTemplateViewV4ResponseTypeDISCOVERYDATAANDEXPLORATION string = "DISCOVERY_DATA_AND_EXPLORATION"
