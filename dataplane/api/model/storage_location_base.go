...
type StorageLocationBase struct {
	...
	// type
	// Enum: [ZEPPELIN_NOTEBOOK YARN_LOG HIVE_METASTORE_WAREHOUSE HIVE_METASTORE_EXTERNAL_WAREHOUSE HIVE_REPLICA_WAREHOUSE HBASE_ROOT RANGER_AUDIT PROFILER_SERVICE_FS_URI DEFAULT_FS FLINK_HISTORYSERVER_ARCHIVE FLINK_JOBMANAGER_ARCHIVE FLINK_CHECKPOINTS FLINK_SAVEPOINTS FLINK_HIGH_AVAILABILITY]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["ZEPPELIN_NOTEBOOK","YARN_LOG","HIVE_METASTORE_WAREHOUSE","HIVE_METASTORE_EXTERNAL_WAREHOUSE","HIVE_REPLICA_WAREHOUSE","HBASE_ROOT","RANGER_AUDIT","PROFILER_SERVICE_FS_URI","DEFAULT_FS","FLINK_HISTORYSERVER_ARCHIVE","FLINK_JOBMANAGER_ARCHIVE","FLINK_CHECKPOINTS","FLINK_SAVEPOINTS","FLINK_HIGH_AVAILABILITY"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
...
const (
	...
	// StorageLocationBaseTypeFLINKHISTORYSERVERARCHIVE captures enum value "FLINK_HISTORYSERVER_ARCHIVE"
	StorageLocationBaseTypeFLINKHISTORYSERVERARCHIVE string = "FLINK_HISTORYSERVER_ARCHIVE"

	// StorageLocationBaseTypeFLINKJOBMANAGERARCHIVE captures enum value "FLINK_JOBMANAGER_ARCHIVE"
	StorageLocationBaseTypeFLINKJOBMANAGERARCHIVE string = "FLINK_JOBMANAGER_ARCHIVE"

	// StorageLocationBaseTypeFLINKCHECKPOINTS captures enum value "FLINK_CHECKPOINTS"
	StorageLocationBaseTypeFLINKCHECKPOINTS string = "FLINK_CHECKPOINTS"

	// StorageLocationBaseTypeFLINKSAVEPOINTS captures enum value "FLINK_SAVEPOINTS"
	StorageLocationBaseTypeFLINKSAVEPOINTS string = "FLINK_SAVEPOINTS"

	// StorageLocationBaseTypeFLINKHIGHAVAILABILITY captures enum value "FLINK_HIGH_AVAILABILITY"
	StorageLocationBaseTypeFLINKHIGHAVAILABILITY string = "FLINK_HIGH_AVAILABILITY"
)
