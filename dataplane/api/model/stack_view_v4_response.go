...
const (
	...
	// StackViewV4ResponseStatusEXTERNALDATABASECREATIONFINISHED captures enum value "EXTERNAL_DATABASE_CREATION_FINISHED"
	StackViewV4ResponseStatusEXTERNALDATABASECREATIONFINISHED string = "EXTERNAL_DATABASE_CREATION_FINISHED"
