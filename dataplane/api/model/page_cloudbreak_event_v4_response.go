...
// PageCloudbreakEventV4Response page cloudbreak event v4 response
// swagger:model PageCloudbreakEventV4Response
...
func (m *PageCloudbreakEventV4Response) validateContent(formats strfmt.Registry) error {
...
func (m *PageCloudbreakEventV4Response) validatePageable(formats strfmt.Registry) error {
...
func (m *PageCloudbreakEventV4Response) validateSort(formats strfmt.Registry) error {
...
func (m *PageCloudbreakEventV4Response) UnmarshalBinary(b []byte) error {
	var res PageCloudbreakEventV4Response
