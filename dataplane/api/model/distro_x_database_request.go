...
type DistroXDatabaseRequest struct {
	...
	DatabaseAzureRequest *DistroXDatabaseAzureRequest `json:"databaseAzureRequest,omitempty"`
...
func (m *DistroXDatabaseRequest) validateDatabaseAzureRequest(formats strfmt.Registry) error {
