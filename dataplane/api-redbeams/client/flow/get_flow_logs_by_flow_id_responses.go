...
func (o *GetFlowLogsByFlowIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetFlowLogsByFlowIDOK()
...
func (o *GetFlowLogsByFlowIDOK) Error() string {
	return fmt.Sprintf("[GET /flow/logs/{flowId}][%d] getFlowLogsByFlowIdOK  %+v", 200, o.Payload)
}

func (o *GetFlowLogsByFlowIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
