...
// APIClient manages communication with the Redbeams API API v2.66.0-b41-1-ge11bb40
...
type APIClient struct {
	...
	DatabaseServersApi *DatabaseServersApiService

	DatabasesApi *DatabasesApiService

	FlowApi *FlowApiService

	FlowPublicApi *FlowPublicApiService

	V4OperationApi *V4OperationApiService

	V4ProgressApi *V4ProgressApiService

	V4UtilsApi *V4UtilsApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.DatabaseServersApi = (*DatabaseServersApiService)(&c.common)
	c.DatabasesApi = (*DatabasesApiService)(&c.common)
	c.FlowApi = (*FlowApiService)(&c.common)
	c.FlowPublicApi = (*FlowPublicApiService)(&c.common)
	c.V4OperationApi = (*V4OperationApiService)(&c.common)
	c.V4ProgressApi = (*V4ProgressApiService)(&c.common)
	c.V4UtilsApi = (*V4UtilsApiService)(&c.common)
