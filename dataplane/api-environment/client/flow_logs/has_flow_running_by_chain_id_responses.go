...
func (o *HasFlowRunningByChainIDReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewHasFlowRunningByChainIDOK()
...
func (o *HasFlowRunningByChainIDOK) Error() string {
	return fmt.Sprintf("[GET /flow_logs/check/chainId/{chainId}][%d] hasFlowRunningByChainIdOK  %+v", 200, o.Payload)
}

func (o *HasFlowRunningByChainIDOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
