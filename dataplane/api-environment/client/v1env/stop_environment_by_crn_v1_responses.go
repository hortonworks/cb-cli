...
func (o *StopEnvironmentByCrnV1Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewStopEnvironmentByCrnV1OK()
...
func NewStopEnvironmentByCrnV1OK() *StopEnvironmentByCrnV1OK {
...
*/
type StopEnvironmentByCrnV1OK struct {
	Payload *model.FlowIdentifier
}

func (o *StopEnvironmentByCrnV1OK) Error() string {
	return fmt.Sprintf("[POST /v1/env/crn/{crn}/stop][%d] stopEnvironmentByCrnV1OK  %+v", 200, o.Payload)
}

func (o *StopEnvironmentByCrnV1OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
