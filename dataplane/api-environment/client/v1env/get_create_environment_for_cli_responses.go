...
func (o *GetCreateEnvironmentForCliReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetCreateEnvironmentForCliOK()
...
func (o *GetCreateEnvironmentForCliOK) Error() string {
	return fmt.Sprintf("[POST /v1/env/cli_create][%d] getCreateEnvironmentForCliOK  %+v", 200, o.Payload)
}

func (o *GetCreateEnvironmentForCliOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
