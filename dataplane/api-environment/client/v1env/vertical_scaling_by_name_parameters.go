...
func (o *VerticalScalingByNameParams) WithBody(body *model.VerticalScaleRequest) *VerticalScalingByNameParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the vertical scaling by name params
func (o *VerticalScalingByNameParams) SetBody(body *model.VerticalScaleRequest) {
	o.Body = body
}
