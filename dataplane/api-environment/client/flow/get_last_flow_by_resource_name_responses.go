...
func (o *GetLastFlowByResourceNameReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetLastFlowByResourceNameOK()
...
func (o *GetLastFlowByResourceNameOK) Error() string {
	return fmt.Sprintf("[GET /flow/logs/resource/name/{resourceName}/last][%d] getLastFlowByResourceNameOK  %+v", 200, o.Payload)
}

func (o *GetLastFlowByResourceNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
