...
// AccountTagResponses account tag responses
// swagger:model AccountTagResponses
...
func (m *AccountTagResponses) validateResponses(formats strfmt.Registry) error {
