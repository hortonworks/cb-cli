...
type SimpleEnvironmentV1Response struct {
	...
	// Enum: [CREATION_INITIATED DELETE_INITIATED UPDATE_INITIATED NETWORK_CREATION_IN_PROGRESS NETWORK_DELETE_IN_PROGRESS RDBMS_DELETE_IN_PROGRESS FREEIPA_CREATION_IN_PROGRESS FREEIPA_DELETE_IN_PROGRESS CLUSTER_DEFINITION_CLEANUP_PROGRESS IDBROKER_MAPPINGS_DELETE_IN_PROGRESS S3GUARD_TABLE_DELETE_IN_PROGRESS AVAILABLE ARCHIVED CREATE_FAILED DELETE_FAILED UPDATE_FAILED]
...
func init() {
	var res []string
	if err := json.Unmarshal([]byte(`["CREATION_INITIATED","DELETE_INITIATED","UPDATE_INITIATED","NETWORK_CREATION_IN_PROGRESS","NETWORK_DELETE_IN_PROGRESS","RDBMS_DELETE_IN_PROGRESS","FREEIPA_CREATION_IN_PROGRESS","FREEIPA_DELETE_IN_PROGRESS","CLUSTER_DEFINITION_CLEANUP_PROGRESS","IDBROKER_MAPPINGS_DELETE_IN_PROGRESS","S3GUARD_TABLE_DELETE_IN_PROGRESS","AVAILABLE","ARCHIVED","CREATE_FAILED","DELETE_FAILED","UPDATE_FAILED"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
