...
// AccountTelemetryRequest account telemetry request
// swagger:model AccountTelemetryRequest
...
func (m *AccountTelemetryRequest) validateFeatures(formats strfmt.Registry) error {
...
func (m *AccountTelemetryRequest) validateRules(formats strfmt.Registry) error {
...
func (m *AccountTelemetryRequest) UnmarshalBinary(b []byte) error {
	var res AccountTelemetryRequest
