...
func (o *AddClusterParams) WithBody(body *model.AutoscaleClusterRequest) *AddClusterParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the add cluster params
func (o *AddClusterParams) SetBody(body *model.AutoscaleClusterRequest) {
	o.Body = body
}
