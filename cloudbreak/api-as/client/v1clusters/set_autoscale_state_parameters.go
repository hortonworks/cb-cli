...
type SetAutoscaleStateParams struct {
	...
	/*Body*/
	Body *model.AutoscaleClusterState
	/*ClusterID*/
	ClusterID int64
...
func (o *SetAutoscaleStateParams) WithBody(body *model.AutoscaleClusterState) *SetAutoscaleStateParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the set autoscale state params
func (o *SetAutoscaleStateParams) SetBody(body *model.AutoscaleClusterState) {
	o.Body = body
}
