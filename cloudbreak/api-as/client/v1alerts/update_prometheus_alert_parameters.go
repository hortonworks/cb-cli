...
func (o *UpdatePrometheusAlertParams) WithBody(body *model.PrometheusAlertRequest) *UpdatePrometheusAlertParams {
	o.SetBody(body)
	return o
}

// SetBody adds the body to the update prometheus alert params
func (o *UpdatePrometheusAlertParams) SetBody(body *model.PrometheusAlertRequest) {
	o.Body = body
}
