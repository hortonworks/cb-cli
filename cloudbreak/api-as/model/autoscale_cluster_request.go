...
// AutoscaleClusterRequest autoscale cluster request
// swagger:model AutoscaleClusterRequest
type AutoscaleClusterRequest struct {

	// Ambari server host address
	Host string `json:"host,omitempty"`

	// Metric based alerts of the cluster
	MetricAlerts []*MetricAlertRequest `json:"metricAlerts"`
	...
	PrometheusAlerts []*PrometheusAlertRequest `json:"prometheusAlerts"`
	...
	TimeAlerts []*TimeAlertRequest `json:"timeAlerts"`

	// Ambari server username
	User string `json:"user,omitempty"`
}

// Validate validates this autoscale cluster request
func (m *AutoscaleClusterRequest) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *AutoscaleClusterRequest) validateMetricAlerts(formats strfmt.Registry) error {
...
func (m *AutoscaleClusterRequest) validatePrometheusAlerts(formats strfmt.Registry) error {
...
func (m *AutoscaleClusterRequest) validateScalingConfiguration(formats strfmt.Registry) error {
...
func (m *AutoscaleClusterRequest) validateStackID(formats strfmt.Registry) error {
...
func (m *AutoscaleClusterRequest) validateTimeAlerts(formats strfmt.Registry) error {
...
func (m *AutoscaleClusterRequest) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *AutoscaleClusterRequest) UnmarshalBinary(b []byte) error {
	var res AutoscaleClusterRequest
