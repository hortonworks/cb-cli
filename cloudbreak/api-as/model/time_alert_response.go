...
// TimeAlertResponse time alert response
// swagger:model TimeAlertResponse
type TimeAlertResponse struct {
...
// Validate validates this time alert response
func (m *TimeAlertResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TimeAlertResponse) validateAlertName(formats strfmt.Registry) error {
...
func (m *TimeAlertResponse) validateScalingPolicy(formats strfmt.Registry) error {
...
func (m *TimeAlertResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *TimeAlertResponse) UnmarshalBinary(b []byte) error {
	var res TimeAlertResponse
