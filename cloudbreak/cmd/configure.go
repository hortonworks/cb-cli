...
func init() {
	CloudbreakCommands = append(CloudbreakCommands, cli.Command{
		...
		Flags:  fl.NewFlagBuilder().AddFlags(fl.FlServerRequired, fl.FlUsernameRequired, fl.FlPassword, fl.FlTenantRequired, fl.FlProfileOptional, fl.FlAuthTypeOptional, fl.FlWorkspaceOptional).AddOutputFlag().Build(),
		Action: configure.Configure,
		BashComplete: func(c *cli.Context) {
			for _, f := range fl.NewFlagBuilder().AddFlags(fl.FlServerRequired, fl.FlUsernameRequired, fl.FlPassword, fl.FlTenantRequired, fl.FlProfileOptional, fl.FlAuthTypeOptional, fl.FlWorkspaceOptional).AddOutputFlag().Build() {
