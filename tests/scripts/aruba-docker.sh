...
echo "Configure CB CLI to Server: $BASE_URL User: $USERNAME_CLI Password: $PASSWORD_CLI Tenant: $TENANT"
cb configure --server $BASE_URL --username $USERNAME_CLI --password $PASSWORD_CLI --workspace $USERNAME_CLI --tenant $TENANT
