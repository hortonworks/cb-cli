...
echo "Configure CB CLI to BASE_URL=$BASE_URL USERNAME_CLI=$USERNAME_CLI PASSWORD_CLI=$PASSWORD_CLI TENANT=$TENANT"
cb configure --server $BASE_URL --username $USERNAME_CLI --password $PASSWORD_CLI --tenant $TENANT
